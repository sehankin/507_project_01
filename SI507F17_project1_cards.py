...
def play_war_game(testing=False):
    # Call this with testing = True and it won't print out
    # all the game mechanics, which makes it easier to see tests.
    player1 = Deck()
    player2 = Deck()
...
def show_song(inp="Winner"):  # default winner ...
    ...
    lst = ["win", "winner", "hurrah", "hooray"]
    songs_resp = helper_functions.get_and_cache_songs(random.choice(lst))
...
# id495954957?i=495955054&uo=4" doesn’t understand the
